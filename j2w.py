...
with tab2:
    ...
    # Nút cho phép tải thẳng file vừa upload từ server về lại máy cá nhân ngay lập tức
    if mistral_file is not None:
        st.download_button(
            label="📥 Tải file vừa upload về máy của bạn",
    ...
    # --- HIỂN THỊ CỐ ĐỊNH DANH SÁCH DEBUG TÊN FILE ẢNH ---
